...
export default function OperationSidebar({
  ...
  const [flightViewMode, setFlightViewMode] = React.useState("ACTIVE");
  const flightsToShow = flightViewMode === "ACTIVE" ? activeFlights : nonActiveFlights; 
  const filteredFlights = flightsToShow.filter((f) => {
    if (
      flightFilterCode &&
    ...
    if (flightFilterOrigin && f.origin?.code !== flightFilterOrigin) return false;
        ...
        <div className="sidebar-content">
          {isDetailView ? (
            ...
            <>
              ...
              {sidebarTab === "flights" && (
                <>
                  <div className="flight-toggle-row">
                    <button
                      className={`flight-toggle-btn ${
                        flightViewMode === "ACTIVE" ? "active" : ""
                      }`}
                      onClick={() => { 
                        setFlightViewMode("ACTIVE")
                        onClearSelection(); 
                      }}
                    >
                      Activos ({activeFlights.length})
                    </button>

                    <button
                      className={`flight-toggle-btn ${
                        flightViewMode === "INACTIVE" ? "active" : ""
                      }`}
                      onClick={() => { 
                        setFlightViewMode("INACTIVE")
                        onClearSelection(); 
                      }}
                    >
                      Próximos ({nonActiveFlights.length})
                    </button>
                  </div>
