...
public class PlanificationRequest {
    ...
    public Boolean getReparametrizar() {
        return reparametrizar;
    }
    public void setReparametrizar(Boolean reparametrizar) {
        this.reparametrizar = reparametrizar;
    }
    public ParametersRequest getParameters() { return parameters; }
    public void setParameters(ParametersRequest parameters) {
        this.parameters = parameters;
    }
}
