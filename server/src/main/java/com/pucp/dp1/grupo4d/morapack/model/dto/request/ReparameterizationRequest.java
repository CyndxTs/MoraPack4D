/**]
 >> Project:    MoraPack
 >> Author:     Grupo 4D
 >> File:       ReparameterizationRequest.java
 [**/
...
public class ReparameterizationRequest {
    ...
    private LocalDateTime fechaHoraIni = LocalDateTime.of(1999,12,31,23,59,59);
    ...
    public ReparameterizationRequest() {}
