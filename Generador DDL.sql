...
CREATE TABLE IF NOT EXISTS `morapack4d`.`SEGMENTACION` (
  ...
  `fh_inicio_aplicacion_local` DATETIME NOT NULL,
  `fh_inicio_aplicacion_utc` DATETIME NOT NULL,
  `fh_fin_sustitucion_local` DATETIME NULL DEFAULT NULL,
  `fh_fin_sustitucion_utc` DATETIME NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `morapack4d`.`LOTE` (
  ...
  `codigo_lote_padre` VARCHAR(30) NULL DEFAULT NULL,
  `id_segmentacion` INT NOT NULL,
  `id_ruta` INT NOT NULL,
  `estado` ENUM('PLANIFICADO', 'POR_REPLANIFICAR', 'REPLANIFICADO') NOT NULL DEFAULT 'PLANIFICADO',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `codigo_UNIQUE` (`codigo` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `morapack4d`.`REGISTRO` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `codigo` VARCHAR(30) NOT NULL,
  `sigue_vigente` TINYINT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `morapack4d`.`PARAMETROS` (
  ...
  `fh_inicio` DATETIME NOT NULL DEFAULT '1999-12-31 23:59:59',
  `fh_fin` DATETIME NOT NULL DEFAULT '2999-12-31 23:59:59',
...
CREATE TABLE IF NOT EXISTS `morapack4d`.`EVENTO` (
  ...
  `fh_salida_local` DATETIME NULL DEFAULT NULL,
  `fh_salida_utc` DATETIME NULL DEFAULT NULL,
  `fh_llegada_local` DATETIME NULL DEFAULT NULL,
  `fh_llegada_utc` DATETIME NULL DEFAULT NULL,
  `id_plan` INT NOT NULL,
  PRIMARY KEY (`id`),
