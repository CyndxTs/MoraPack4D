...
public class PlanDeVuelo {
    ...
    public Double calcularProximidad(LocalDateTime fechaHoraActual,Aeropuerto aDest) {
        ...
        Integer destCapDisp = this.destino.obtenerCapacidadDisponible(G4D.toUTC(G4D.toDateTime(this.horaLlegada,fechaHoraActual),this.destino.getHusoHorario()));
    ...
    public Boolean esAlcanzable(LocalDateTime fechaHoraActual,LocalDateTime fechaHoraLimite) {
        LocalDateTime fechaHoraSalidaUTC =  G4D.toUTC(
            G4D.toDateTime(this.horaSalida,fechaHoraActual),
            this.origen.getHusoHorario()
        );
        LocalDateTime fechaHoraLlegadaUTC =  G4D.toUTC(
            G4D.toDateTime(this.horaLlegada,fechaHoraActual),
    ...
    public void setDuracion() {
        this.duracion = G4D.getElapsedHours(
            G4D.toUTC(this.horaSalida,this.origen.getHusoHorario()),
            G4D.toUTC(this.horaLlegada,this.destino.getHusoHorario())
        );
    }
