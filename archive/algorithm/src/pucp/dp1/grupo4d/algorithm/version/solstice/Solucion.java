...
public class Solucion {
    ...
    public void setRatioPromedioDeUtilizacionTemporal() {
        ...
        for(Ruta ruta : this.rutasEnOperacion) {
            double duracionTotal = ruta.obtenerDuracionActivaTotal() + ruta.obtenerDuracionPasivaTotal(ruta.getFechaHoraSalidaUTC());
            double duracionMaxima = ruta.getTipo().getMaxHorasParaEntrega();
            sumaRatios += duracionTotal/duracionMaxima;
        }
