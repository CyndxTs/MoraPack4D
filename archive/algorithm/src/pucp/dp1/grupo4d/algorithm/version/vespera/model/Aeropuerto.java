...
public class Aeropuerto {
    ...
    public Double obtenerDistanciaHasta(Aeropuerto aDest) {
        return G4D.getGeodesicDistance(latitudDEC,longitudDEC,aDest.latitudDEC,aDest.longitudDEC);
    }
    ...
    public void registrarProducto(String idProducto, LocalDateTime fechaHoraIngreso, LocalDateTime fechaHoraEgreso) {
        ...
        registro.setFechaHoraIngresoLocal(G4D.toLocal(fechaHoraIngreso,this.husoHorario));
        registro.setFechaHoraEgresoUTC(fechaHoraEgreso);
        registro.setFechaHoraEgresoLocal((fechaHoraEgreso != null) ? G4D.toLocal(fechaHoraEgreso,this.husoHorario) : null);
    ...
    public void setLatitud(String latitudDMS) {
        ...
        this.latitudDEC = G4D.toLatDEC(latitudDMS);
    }

    public void setLatitud(Double latitudDEC) {
        this.latitudDEC = latitudDEC;
        this.latitudDMS = G4D.toLatDMS(latitudDEC);
    }
    ...
    public void setLongitud(String longitudDMS) {
        ...
        this.longitudDEC = G4D.toLonDEC(longitudDMS);
    }

    public void setLongitud(Double longitudDEC) {
        this.longitudDEC = longitudDEC;
        this.longitudDMS = G4D.toLonDMS(longitudDEC);
    }
}
