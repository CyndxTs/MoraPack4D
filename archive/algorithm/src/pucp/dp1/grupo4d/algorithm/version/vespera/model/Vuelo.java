...
public class Vuelo {
    ...
    public void instanciarHorarios(LocalDateTime fechaHoraReferencia) {
        this.fechaHoraSalidaLocal = G4D.toDateTime(this.plan.getHoraSalida(),fechaHoraReferencia);
        this.fechaHoraSalidaUTC = G4D.toUTC(this.fechaHoraSalidaLocal,this.plan.getOrigen().getHusoHorario());
        this.fechaHoraLlegadaLocal = G4D.toDateTime(this.plan.getHoraLlegada(),fechaHoraReferencia);
